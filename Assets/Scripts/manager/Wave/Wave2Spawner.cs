        ...
        while (spawnStep < 9)
        {
            switch (spawnStep)
            {
                ...
                case 1: // 두 번째 스폰: IceGolem 3마리 (가운데는 flag 1)
                    wave.spawnEnemy(new Vector3(-10, 0, 10), 5);
                    wave.spawnItemEnemy(new Vector3(0, 0, 10), 5);
                    wave.spawnEnemy(new Vector3(10, 0, 10), 5);
                    break;

                case 2: // 세 번째 스폰: ghost 2마리
                    wave.spawnEnemy(new Vector3(-5, 0, 10), 7);
                    wave.spawnEnemy(new Vector3(5, 0, 10), 7);
                    break;

                case 3: // 네 번째 스폰: 양쪽에 Black Widow, 가운데 TurtleShell 1마리
                    wave.spawnEnemy(new Vector3(-10, 0, 10), 4);
                    wave.spawnEnemy(new Vector3(0, 0, 10), 2);
                    wave.spawnEnemy(new Vector3(10, 0, 10), 4);
                    break;

                case 4: // 다섯 번째 스폰: 양쪽에 TurtleShell, 가운데 Slime (가운데는 flag 1)
                    wave.spawnEnemy(new Vector3(-10, 0, 10), 2);
                    wave.spawnItemEnemy(new Vector3(0, 0, 10), 3);
                    wave.spawnEnemy(new Vector3(10, 0, 10), 2);
                    break;

                case 5: // 여섯 번째 스폰: ghost 3마리
                    wave.spawnEnemy(new Vector3(-10, 0, 10), 7);
                    wave.spawnEnemy(new Vector3(0, 0, 10), 7);
                    wave.spawnEnemy(new Vector3(10, 0, 10), 7);
                    break;
